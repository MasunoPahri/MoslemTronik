		...
		<form class="form-horizontal" role="form" method="post">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" 
					for="form-field-select-1">Merk Handphone</label>
				<div class="col-sm-9">
					<select class="col-xs-10 col-sm-5" name="vendor" id="vendor">
						<option value="">-Pilih Merk-</option>
						<?php
						$vendor = mysql_query("SELECT * FROM tb_katevendor WHERE jns_brg='hp'");
			...
			<div class="form-group t2">
				<label class="col-sm-3 control-label no-padding-right" 
					for="form-field-2">Tipe Handphone</label>
				<div class="col-sm-9">
					<input type="text" name="tipe_hp" id="form-field-2" class="col-xs-10 col-sm-5" />
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right"
					for="form-field-icon-1">Jumlah Stok HP (Unit)</label>
		...
		<!-- PAGE CONTENT BEGINS -->
			...
			<div>
				<table id="dynamic-table" class="table table-striped table-bordered table-hover">
					...
					<tbody>
						<?php
						$kartu = mysql_query("SELECT * FROM tb_stok INNER JOIN tb_detailhp
						...
						<tr>
							...
							<td>
								<a href="#">
									<?php echo $get['merk_hp']." ".$get['tipe']."GB"; ?>
								</a>
							</td>
