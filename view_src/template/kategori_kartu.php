...
if (isset($_SESSION['msg'])) {
	...
	?>
	<div class="alert alert-success" role="alert">Kategori kartu berhasil ditambahkan!</div>
	<?php
	}else{
	?>
		<div class="alert alert-danger" role="alert">Kategori kartu gagal ditambahkan!</div>
	<?php
	}
	unset($_SESSION['msg']);
}
		...
		<form class="form-horizontal" role="form" method="post">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right"
					for="form-field-icon-1">Kode Kartu</label>

				<div class="col-sm-9">
					<input data-rel="tooltip" type="text" required pattern="[a-zA-Z]*"
			...
			<input type="hidden" name="jns" value="kartu">
