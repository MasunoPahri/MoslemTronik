...
<form action="#" class="formItem kartu" name="brg" method="post">
	<div id="hp" class="itemBuy">
		<div class="row itemBrg">
			...
			<div class="col-sm-2">
				...
				<input name="unit[]" class="form-control unitBrg" id="hp" required type="number">
			</div>
			<div class="col-sm-2">
				<br>
	...
	<input type="hidden" value="hp" name="barang">
</form>

<p>
	<button type="button" id="hp" class="btn btn-white btn-primary addMore">
		<i class="ace-icon fa fa-plus bigger-120"></i>
		Tambah Barang
	</button>

	<button type="button" id="hp" class="btn btn-white btn-success bayar">
