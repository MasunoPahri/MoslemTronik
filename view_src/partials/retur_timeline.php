<?php
$tperDay = mysql_query("SELECT DISTINCT(DATE(buy_at)) AS tgl FROM tb_retur
...
<div class="timeline-container">
	...
	<div class="timeline-items">
		<?php
		$transaksi = mysql_query("SELECT * FROM tb_retur 
				...
				<div class="widget-body">
					<div class="widget-main">
						<?php 
							...
							echo $get['unit']." Buah"."<br>";
							echo "Diganti dengan: ".$get['brg_renew']."<br>";
							echo "Keterangan: ".$get['keterangan']."<br>";
