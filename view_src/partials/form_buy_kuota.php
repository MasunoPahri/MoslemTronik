...
<form action="#" class="formItem kartu" name="brg" method="post">
	<div id="kuota" class="itemBuy">
		<div class="row itemBrg">
			...
			<div class="col-sm-2">
				...
				<input name="unit[]" class="unitBrg form-control" id="kuota" required type="number">
			</div>
			<div class="col-sm-2">
				<br>
	...
	<input type="hidden" value="kartu" name="barang">
</form>

<p>
	<button type="button" id="kuota" class="btn btn-white btn-primary addMore">
		<i class="ace-icon fa fa-plus bigger-120"></i>
		Tambah Barang
	</button>

	<button type="button"  id="kuota" class="btn btn-white btn-success bayar">
